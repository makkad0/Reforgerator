...
📌 Custom Frames
   ...
   1. Create one or more .ini files in the
      `<custom_frames_folder>` directory. Each file should contain a main section and may include optional sections for specific sizes and styles.
...
──────────────────────────────────────────────────────────────────────────────
 3.3. LICENSE
──────────────────────────────────────────────────────────────────────────────
<program-name> is licensed under the MIT License. For more details, see the `LICENSE` file.
